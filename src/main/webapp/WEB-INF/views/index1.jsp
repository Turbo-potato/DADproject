                        ...
                        <div class="col-xs-6 col-md-3 room floor_1">
                            ...
                            <div class="info white_with_shadow">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 name"><p>Library</p></div>
                        ...
                        <div class="col-xs-6 col-md-3 room floor_2">
                            ...
                            <div class="info white_with_shadow">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 name"><p>Laboratory</p></div>
                                    <div class="col-xs-2 link"> <p>
                                        <a href="#226">
                                            <i class="go_link"></i>
                                        </a>
                        ...
                        <div class="col-xs-6 col-md-3 room floor_3">
                            ...
                            <div class="info white_with_shadow">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 name"><p>Lecture Hall</p></div>
                                    <div class="col-xs-2 link"> <p>
                                        <a href="#301">
                                            <i class="go_link"></i>
                                        </a>
                        ...
                        <div class="col-xs-6 col-md-3 room floor_3">
                            ...
                            <div class="info white_with_shadow">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 name"><p>laboratory cabinet</p></div>
                                    <div class="col-xs-2 link"> <p>
                                        <a href="#304">
                                            <i class="go_link"></i>
                                        </a>
                        ...
                        <div class="col-xs-6 col-md-3 room floor_3">
                            ...
                            <div class="info white_with_shadow">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 name"><p>laboratory work</p></div>
                                    <div class="col-xs-2 link"> <p>
                                        <a href="#305">
                                            <i class="go_link"></i>
                                        </a>
                        ...
                        <div class="col-xs-6 col-md-3 room floor_3">
                            ...
                            <div class="info white_with_shadow">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 name"><p>Practice cabinet</p></div>
                                    <div class="col-xs-2 link"> <p>
                                        <a href="#312">
                                            <i class="go_link"></i>
                                        </a>
                        ...
                        <div class="col-xs-6 col-md-3 room floor_3">
                            ...
                            <div class="info white_with_shadow">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5 name"><p>PR department</p></div>
                                    <div class="col-xs-2 link"> <p>
                                        <a href="#332">
                                            <i class="go_link"></i>
                                        </a>
...
<script async="" src="https://www.googletagmanager.com/gtag/js?id=UA-120476488-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-120476488-1');
</script>
...
'https://connect.facebook.net/en_US/fbevents.js');
 fbq('init', '1838703589486144'); 
fbq('track', 'PageView');
</script>
<noscript>
 <img height="1" width="1" 
src="https://www.facebook.com/tr?id=1838703589486144&ev=PageView
&noscript=1"/>
</noscript>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter39957780 = new Ya.Metrika({
                    id:39957780,
                    clickmap:true,
                    trackLinks:true,
